...
* [Security Windows](security/README.md)
  * [Disable Disconnected Interface](security/disable-disconnected-interface.md)
  * [Disable External Interface](security/disable-external-interface.md)
  * [Security policy apply](security/security-policy-apply.md)
  * [Windows Server Backup](security/windows-server-backup.md)
  * [Disable McAfee Agent](security/disable-mcafee-agent.md)
