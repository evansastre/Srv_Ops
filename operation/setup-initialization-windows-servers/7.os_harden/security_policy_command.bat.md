...
wmic useraccount where name="Administrator" call rename name="CoffeeBean"


::::::::2.4 Password Policy Settings
wmic UserAccount where Name="Starbucks" set PasswordExpires=True
wmic UserAccount where Name="CoffeeBean" set PasswordExpires=True
wmic UserAccount where Name="youc" set PasswordExpires=True
wmic UserAccount where Name="huangsl" set PasswordExpires=True

wmic UserAccount where Name="khongcw" set PasswordExpires=True
wmic UserAccount where Name="liusq" set PasswordExpires=True
wmic UserAccount where Name="justin" set PasswordExpires=True
wmic UserAccount where Name="NC-Dev" set PasswordExpires=True
wmic UserAccount where Name="NC-Ops" set PasswordExpires=True
wmic UserAccount where Name="NC-Platform" set PasswordExpires=True
wmic UserAccount where Name="NC-Platform2" set PasswordExpires=True
wmic UserAccount where Name="NC-Security" set PasswordExpires=True
...
::1day logoff disconnected user [not for logD01 and logD03]

::MaxDisconnectionTime logD0* exclude
::gpedit.msc -> Compiter Configuration -> Administrative Templates -> Windows Components -> Remote Desktop Services -> Remote Desktop Session Host -> Session Time Limits -> Set time limit for disconnected session -> "Enabled" -> "1 day"
...
::salt 'ArenaD01' cmd.run 'netsh interface set interface "Local Area Connection 3" admin=disable'

::http://gtoconfluence.garenanow.com:8090/display/BNS/Disable+Disconnected+Interface



:::::::: e4.disable all DB server external interface

::http://gtoconfluence.garenanow.com:8090/display/BNS/Disable+External+Interface
